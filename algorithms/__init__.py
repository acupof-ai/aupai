"""RL algorithms for the 200M Chinese LLM: GSPO/RLVR training loops and
...
Submodules:
  ...
  rlvr_trainer   — RLVR GSPO training loop: fp32 master weights, FP8 train +
