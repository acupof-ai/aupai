...
## Domain blocks — mix_scale domains (pod, stamped 2026-08-29)

Each block is the rebuild contract from docs/standards/corpus_rebuild.md. The
fingerprint is `scripts/corpus_fingerprint.py`'s value (name+size+mtime of the
shards); `harness check` corpus_fp_matches compares it to the live directory.
Bytes are `du -sb` on the pod. web_hq is the lost domain: its fineweb2 bytes
...
- Result: fingerprint: 632a09b4c5e433d5, 920,692 docs, 8,119,279,450 bytes
- Build: unrecorded (pre-0830v1; reconstruct from git history before any rebuild)

### wiki

- Result: fingerprint: 466e012ddcdff27c, 212,413 docs, 910,063,480 bytes
- Build: unrecorded (pre-0830v1; reconstruct from git history before any rebuild)

### en

- Result: fingerprint: 6488892612c68468, 117,532 docs, 811,935,014 bytes
...
- Result: fingerprint: 45a430e04f7cc285, 74,158 docs, 335,034,730 bytes
...
- Result: fingerprint: 4317ab461ca5716a, 199,976 docs, 232,707,019 bytes
...
- Result: fingerprint: f4b03c9ff45354e0, 160,414 docs, 163,274,317 bytes
