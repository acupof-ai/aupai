...
#   name          v41_ced_w8smoke_0923 -> v41_ced_0923
...
export NGPU=8
exec python3 scripts/harness.py launch v41_ced_0923 \
  --training --class incremental --gate-timeout 3000 \
  --hypothesis "V4.1 CED (bottom 6 encoder / top 6 decoder, global KV from H_6) on the UltraData gate mix clears HumanEval pass@1 >= 30%; single arm, no flat control -- flat was stopped 2026-09-22 by user order" \
  -- ./run_ddp.sh --mix data/mix_v41_gate.json --name v41_ced_0923 \
