...
exec python3 scripts/harness.py launch v41_ced_0926 \
  ...
  --hypothesis "resume v41_ced_0926 from step8000 with router AdamW weight decay 0.1 (--moe_router_wd, the one delta): router cross-expert logit std 4.12/4.63/4.98 at 2000/4000/6000 rose three times, prereg v41_ced_0923 amendment 7; the rise stops or reverses by step 12000" \
  -- ./run_ddp.sh --mix data/mix_v41_gate.json --name v41_ced_0926 \
  --resume ckpt_v41_ced_0926.pt.step8000 \
  ...
  --stochastic_round --router_score sigmoid --moe_router_lr 0.001 --moe_router_wd 0.1
