...
| A criterion must express the property asked; test it on known-answer positive and negative worlds before trusting output | 14 | §9 §10 §23 §26 §29 §31 §34 §35 §40 §45 §48 §54 §56 §61 |
...
| Check a launch line's shape against `facts/efficiency.j | manual: 44-20: the check is assigned and not yet written. Both sides ARE static -- the launch line's (batch, accum, seq, layers) and the fact store's config blocks -- so this is manual only until that lands, not manual by nature |
