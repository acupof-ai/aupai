...
| Artifacts carry their producer's identity; missing identity refuses, never rebuilds | 7 | §4 §24 §44 §182 §189 §210 §284 |
| Failures must be loud: checks before the write, raise or exit nonzero, never print-and-continue | 16 | §7 §13 §25 §51 §59 §136 §166 §181 §188 §193 §197 §204 §251 §256 §265 §288 |
...
| A predicate set answers the question it enumerates, not the one it is named for; assert its population against the filesystem, never against a list; to measure a correction for an instrument, call the instrument | 5 | §275 §276 §277 §278 §289 |
