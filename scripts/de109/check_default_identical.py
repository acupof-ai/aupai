"""de-109 default-path identity gate, environment-independent.

A fixed-seed forward+backward of one CSA2 layer with cfg.csa2_win_flash UNSET must be
...
Run:
    python3 scripts/de109/check_default_identical.py <candidate_model.py> \
...
def main():
    ...
    assert href == hgot, (
        ...
        "(candidate and baseline model.py differ when csa2_win_flash is unset)")
