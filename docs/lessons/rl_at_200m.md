---
question: What does the evidence support for RL at a 200M Chinese math model?
status: recorded
source: arXiv API + abstract-page fetches and internal runs, 2026-08-29; internal numbers re-verified against runs/experiments.jsonl
---
