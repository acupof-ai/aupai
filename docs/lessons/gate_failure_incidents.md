...
Fourteen land at 33-50 s and seventeen at 730-1031 s, median 734, with nothing between 50 and 730. The **main-only** population, restricted to `push` runs on `main` (bc, 2026-09-21), is 21 fast at 33-56 s and 9 slow at 728-979 s, median 49.5 -- a different median from a different set, and neither is "the" step duration. The earlier version of this paragraph printed the pooled median 754 with no population at all, which is a number anyone can recompute correctly and differently.
