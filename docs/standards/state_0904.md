...
- N2 "larger params at fixed compute": re-scored on doc_cu (C11, 53c39d82) — the margin is **−0.0010 nat** (cu_none −0.0108; 90.7 % of the cu_none margin was the eval path, not the model); against `ds.seed_variance_0p2b` sd 0.0516 this is 1/52 of a seed sd; block-paired stats pending (E20) (`ds.n2_params_vs_data_matched_compute`).
