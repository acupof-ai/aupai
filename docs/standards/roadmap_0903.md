...
| its anchors on the same 29,662 bytes | gzip -9 2.096, bzip2 1.897, Pythia-160M @4.2B tok 0.918 bits/byte | measured 2026-09-03 |
...
| N2 | params-vs-data verdict | fb / b0 | one delta: domain_loss(params leg) − domain_loss(data leg) on the shared val cache, in nat, beside the seed σ from N3; decision line names the 30B shape | at params-leg end, equal compute so equal wall time, ~6.8 h: ~20:00Z 09-03 if launched 13:00Z |
