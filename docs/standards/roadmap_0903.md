...
| N2 | params-vs-data verdict | fb / b0 | one delta: domain_loss(params leg) − domain_loss(data leg) on the shared val cache, in nat, beside the seed σ from N3; decision line names the 30B shape | at params-leg end, est. 09-04 07Z (438M at ~2.1× the step cost, estimate) |
