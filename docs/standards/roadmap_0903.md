...
| N7 result (e1-31, 2026-09-03) | 2x2, each arm scored in its own topology: humaneval BPB unlooped-trained 0.4635 vs looped-trained 0.4658 (+0.0023, SE 0.0006, z 3.6, 103/164); domain_loss 1.9858 vs 1.9951 (+0.0093, 9/9). Mismatch cells are 8-11x larger (+0.0193, +0.0264): weights and topology must match, and Stage A (+0.0273) measured that mismatch, not the loop. Forward latency ~1.3x (1.22-1.34 over four 60-iter reps; the earlier 1.64x was one 20-iter run and is retracted). **Not adopted.** Boundary: 250 SFT steps on a 206M checkpoint rules out cheap adoption, not SMELT's from-scratch claim | runs/n7b_*.json, e1-31 |
