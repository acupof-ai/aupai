...
## 2026-09-07 (229 rows, 113 mechanisms; ran 05:1xZ)
...
| hook: test_launch_claims AST walk misses refactor | 1 | ~25 | fix carried (1/1 rows) |
| defect: save_every doesn't suppress epoch-end save | 1 | n/r | **unfixed** (0/1 rows) |
...
| cause | count | minutes | resolution |
|---|---|---|---|
| override: AUPAI_BEHIND_MAIN_OK=1 bypass behind-main refusal | 106 | ~3 | **open** (e1-54 owner e1: break the behind-main/staged-merge cycle; #44 owner 44 cuts the flag after; 1/106 carry fix, last 09-09 04:17) |
...
## 2026-09-10 (313 rows, 145 mechanisms; ran 04:30Z)

| cause | count | minutes | resolution |
|---|---|---|---|
| override: AUPAI_BEHIND_MAIN_OK=1 bypass behind-main refusal | 121 | ~3 | **open** (task #44, owner 44: post-freeze cut; 1/121 fix) |
| merge: git push origin main exited nonzero; main advanced locally | 43 | n/r | **open** (task #49, owner 44: stop pushing local main; 0/43 fix) |
| hook/near_miss/process_failure: minutes_lost not reported | 4 | ~25 | **unfixed** (0/4 fix) |
| merge: pod_head_manifest.txt conflicts on every branch | 4 | ~16 | superseded (56fa71b5 + 89d86882: untracked, generated by pod_push) |
| other (141 mechanisms, count=1) | 141 | mixed | mixed |
