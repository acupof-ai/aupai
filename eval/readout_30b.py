...
def readout(milestone, paired, score_matrix, milestone_dl, paired_dl, milestone_tokens, selftest=False, ckpt_dir=None):
...
def main():
    ...
    readout(a.milestone, a.paired, a.score_matrix, a.milestone_domain_loss, a.paired_domain_loss, a.milestone_tokens, ckpt_dir=a.ckpt_dir)
